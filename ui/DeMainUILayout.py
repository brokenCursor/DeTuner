...
class DeMainUILayout(object):
    def setupUi(self, MainWindow):
        ...
        self.backup_table.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.backup_table.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.device_info_layout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        ...
        self.device_name_label.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        ...
        self.ios_version_label.setTextInteractionFlags(QtCore.Qt.TextSelectableByMouse)
        ...
        self.serial_number_label.setTextInteractionFlags(QtCore.Qt.TextSelectableByMouse)
        ...
        self.imei_label.setTextInteractionFlags(QtCore.Qt.TextSelectableByMouse)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(290, 200, 160, 231))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.call_history_checkbox = QtWidgets.QCheckBox(self.verticalLayoutWidget_2)
        ...
        self.calendar_checkbox = QtWidgets.QCheckBox(self.verticalLayoutWidget_2)
        ...
        self.camera_roll_checkbox = QtWidgets.QCheckBox(self.verticalLayoutWidget_2)
        ...
        self.contacts_checkbox = QtWidgets.QCheckBox(self.verticalLayoutWidget_2)
        ...
        self.voice_memos_checkbox = QtWidgets.QCheckBox(self.verticalLayoutWidget_2)
        ...
        self.voicemail_checkbox = QtWidgets.QCheckBox(self.verticalLayoutWidget_2)
        ...
        self.backup_info_label.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        ...
        self.backup_date_label.setTextInteractionFlags(QtCore.Qt.TextSelectableByMouse)
        ...
        self.backup_itunes_ver_label.setTextInteractionFlags(QtCore.Qt.TextSelectableByMouse)
        ...
        self.backup_is_encrypted_label.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        self.backup_is_encrypted_label.setObjectName("backup_is_encrypted_label")
        ...
        self.backup_passcode_set_label.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.add_backup_button.setStatusTip(_translate("MainWindow", "Import backup from non-iTunes directory"))
        self.add_backup_button.setText(_translate("MainWindow", "Add backup"))
        self.backup_table.setStatusTip(_translate("MainWindow", "Table of imported backups"))
        ...
        self.device_name_label.setStatusTip(_translate("MainWindow", "User-specified device name"))
        self.device_name_label.setText(_translate("MainWindow", "**Device Name**"))
        self.model_label.setStatusTip(_translate("MainWindow", "Model name"))
        self.model_label.setText(_translate("MainWindow", "Model:"))
        self.ios_version_label.setStatusTip(_translate("MainWindow", "iOS version"))
        self.ios_version_label.setText(_translate("MainWindow", "iOS Version:"))
        self.serial_number_label.setStatusTip(_translate("MainWindow", "Serial Nubmer"))
        ...
        self.call_history_checkbox.setStatusTip(_translate("MainWindow", "Extract call history?"))
        self.call_history_checkbox.setText(_translate("MainWindow", "Call History"))
        self.calendar_checkbox.setStatusTip(_translate("MainWindow", "Extract calendar data?"))
        self.calendar_checkbox.setText(_translate("MainWindow", "Calendar"))
        self.camera_roll_checkbox.setStatusTip(_translate("MainWindow", "Extract Camera Roll?"))
        self.camera_roll_checkbox.setText(_translate("MainWindow", "Camera Roll"))
        self.contacts_checkbox.setStatusTip(_translate("MainWindow", "Extract contacts?"))
        self.contacts_checkbox.setText(_translate("MainWindow", "Contacts"))
        self.notes_checkbox.setStatusTip(_translate("MainWindow", "Extract notes?"))
        self.notes_checkbox.setText(_translate("MainWindow", "Notes"))
        self.sms_checkbox.setStatusTip(_translate("MainWindow", "Extract SMS & iMessage message history?"))
        self.sms_checkbox.setText(_translate("MainWindow", "SMS &&  iMessage"))
        self.voice_memos_checkbox.setStatusTip(_translate("MainWindow", "Extract Voice Memos?"))
        self.voice_memos_checkbox.setText(_translate("MainWindow", "Voice Memos"))
        self.voicemail_checkbox.setStatusTip(_translate("MainWindow", "Extract voicemail?"))
        self.voicemail_checkbox.setText(_translate("MainWindow", "Voicemail Messages"))
        self.extract_label.setText(_translate("MainWindow", "**Extract**:"))
        self.start_button.setStatusTip(_translate("MainWindow", "Start extraction!"))
        self.start_button.setText(_translate("MainWindow", "Start!"))
        self.backup_info_label.setText(_translate("MainWindow", "**Backup Info**"))
        self.backup_date_label.setStatusTip(_translate("MainWindow", "Date of last backup"))
        self.backup_date_label.setText(_translate("MainWindow", "Date:"))
        self.backup_itunes_ver_label.setStatusTip(_translate("MainWindow", "iTunes version used for backup"))
        self.backup_itunes_ver_label.setText(_translate("MainWindow", "iTunes version:"))
        self.backup_is_encrypted_label.setStatusTip(_translate("MainWindow", "Was backup encrypted?"))
        self.backup_is_encrypted_label.setText(_translate("MainWindow", "Encrypted:"))
        self.backup_passcode_set_label.setStatusTip(_translate("MainWindow", "Was passcode set?"))
        self.backup_passcode_set_label.setText(_translate("MainWindow", "Passcode is set:"))
        self.menuFile.setTitle(_translate("MainWindow", "File"))
        self.action_add_backup.setText(_translate("MainWindow", "Add backup"))
        self.action_add_backup.setStatusTip(_translate("MainWindow", "Import backup from non-iTunes directory"))
        self.action_add_backup.setShortcut(_translate("MainWindow", "Ctrl+I"))
        self.action_export.setText(_translate("MainWindow", "Extract"))
        self.action_export.setStatusTip(_translate("MainWindow", "Start extraction!"))
