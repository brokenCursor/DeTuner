...
class DeBackupHandler:
    ...
    def __init__(self, backup: DeBackup, locale: dict):
        ...
        self.__manifest_db = self.__backup.get_path() + os.sep + 'Manifest.db'
    ...
    def extract_file(self, relative_path, output_filename):
        if self.__backup.is_encrypted():
            ...
            filename_in_backup = os.path.join(
                self.__backup.get_path(), file_id[:2], file_id)
            shutil.copyfile(filename_in_backup, output_filename)
    ...
    def extract_contacts(self, **kwargs):
        ...
        self.extract_file(relative_path=c.fetchone()[0],
            ...
            for msg in messages:
                ...
                for att in attachments:
                    ...
                    if file_path.startswith('~'):
                        ...
                        self.extract_file(relative_path=file_path,
